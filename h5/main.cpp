...
int main()
{
    ...
    cout<<&b<<endl;
    /*refA=b;
    cout<<"refA uusi osoittaa osoitteeseen on: "<<&refA<<endl;
    cout<<"refA:n uusi osoittaman muistipaikan arvo on: "<<refA<<endl;
    cout<<"refA:n uusi osoittaman muistipaikan arvo on: "<<a<<endl;*/
    pointerA=&b;

    //*pointerA=b;
    cout << "Pointterin uusi osoittama osoite on: " <<pointerA<<endl;
    cout<<"Pointterin uusi osoittaman muistipaikan arvo on: "<<*pointerA<<endl;
